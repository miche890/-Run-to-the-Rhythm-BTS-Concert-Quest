...
public class PlayerLvlTwo : MonoBehaviour
{
    private static PlayerLvlTwo instance;
    ...
    public static PlayerLvlTwo GetInstance()
    {
        return instance == null ? instance = new PlayerLvlTwo() : instance;
    }
